...
class PointCloudDatasourceSpec extends FunSpec with Matchers with PointCloudTestEnvironment with PointCloudSpatialTestFiles {
  ...
  describe("PointCloudDatasourceSpec") {
    it("should read las / laz files") {
      ...
      las.metadata shouldBe ((Some(Extent(635619.85, 848899.7, 638982.55, 853535.43)),Some(CRS.fromEpsgCode(2993))))
    ...
    it("should read csv files") {
      ...
      text.metadata shouldBe (Some(Extent(289814.15, 4320978.61, 289818.5, 4320980.59)),Some(CRS.fromEpsgCode(3857)))
    ...
    ignore("should read mbio files") {
      ...
      all.metadata shouldBe (Some(Extent(289814.15, 4320978.61, 289818.5, 4320980.59)),Some(CRS.fromEpsgCode(3857)))
